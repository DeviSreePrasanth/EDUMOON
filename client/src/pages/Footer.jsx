...
const Footer = () => {
  return (
    <footer className="bg-[#213555] text-white pt-12 text-[17px] md:text-[18px] font-[450]">
      {/* Top Section */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-10 px-4">
        ...
        {/* Links - Column 1 */}
        <div>
          <ul className="space-y-2 text-[17px] text-gray-200 font-medium">
        ...
        <div>
          ...
          <p className="text-[17px] text-gray-200 mt-2">
      ...
      {/* Bottom Strip */}
      <div className="bg-[#212529] text-center py-4 mt-12 text-[16px] text-gray-300 w-full">
